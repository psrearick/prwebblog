            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <span class="block truncate" :class="selectedItem && selectedItem[primaryKey] === option[primaryKey] ? 'font-semibold' : 'font-normal'">
                            {{ option[label] }}
                        </span>
                        ...
                        <span class="text-indigo-600 absolute inset-y-0 right-0 flex items-center pr-4"
                              v-if="selectedItem && selectedItem[primaryKey] === option[primaryKey]"
                        >
